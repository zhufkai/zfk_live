//
// Created by zhufk on 2019/8/8.
//
#include "com_zhufk_zfk_1live_live_PushNative.h"
#include <android/log.h>
#include <stdlib.h>
#include <android/native_window_jni.h>
#include <android/native_window.h>
#define LOGI(FORMAT, ...) __android_log_print(ANDROID_LOG_INFO,"zhufk",FORMAT,##__VA_ARGS__)
#define LOGE(FORMAT, ...) __android_log_print(ANDROID_LOG_ERROR,"zhufk",FORMAT,##__VA_ARGS__)
...
JNIEXPORT void JNICALL Java_com_zhufk_zfk_1live_live_PushNative_startPush(JNIEnv *env, jobject jobj, jstring url_jstr) {
    //jobj(PushNative对象)
...
JNIEXPORT void JNICALL Java_com_zhufk_zfk_1live_live_PushNative_stopPush(JNIEnv *env, jobject jobj) {
    is_pushing = FALSE;
}

JNIEXPORT void JNICALL Java_com_zhufk_zfk_1live_live_PushNative_release(JNIEnv *env, jobject jobj) {
...
JNIEXPORT void JNICALL Java_com_zhufk_zfk_1live_live_PushNative_fireVideo(JNIEnv *env, jobject jobj, jbyteArray buffer) {
    //视频数据转为YUV420P
    //NV21->YUV420P
...
JNIEXPORT void JNICALL Java_com_zhufk_zfk_1live_live_PushNative_setVideoOptions(JNIEnv *env, jobject jobj, jint width, jint height, jint bitrate, jint fps) {
    x264_param_t param;
...
JNIEXPORT void JNICALL Java_com_zhufk_zfk_1live_live_PushNative_setAudioOptions(JNIEnv *env, jobject jobj,
...
JNIEXPORT void JNICALL Java_com_zhufk_zfk_1live_live_PushNative_fireAudio(JNIEnv *env, jobject jobj, jbyteArray buffer,
                                                   jint len) {
    int *pcmbuf;
